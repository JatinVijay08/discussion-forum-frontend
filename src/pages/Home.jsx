            ...
            <div className="grid grid-cols-1 lg:grid-cols-[1fr_minmax(auto,680px)_1fr] gap-8 lg:gap-12 w-full">
                    ...
                    <div className="flex items-center gap-2 mb-10">
                        {tabs.map((tab) => (
                            <button
                                ...
                                className={`flex items-center gap-2 px-5 py-2.5 rounded-full text-[12px] font-[800] uppercase tracking-[0.1em] transition-all duration-200 cursor-pointer ${
                                    activeTab === tab.key
                ...
                <div className="hidden lg:block w-full">
                    ...
                    <button
                        ...
                        className="w-full btn-primary btn-pill cta-glow flex items-center justify-center gap-2 py-3.5 text-[14px] cursor-pointer"
                    >
